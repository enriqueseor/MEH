...
public class TilesetPickerPanel extends JPanel {
	...
	public void DrawTileset() {
		...
		gcBuff.drawImage(global.getTileSet(viewingPalette, BlockRenderer.currentTime), 0, 0, this);
		gcBuff.drawImage(local.getTileSet(viewingPalette, BlockRenderer.currentTime), 0, global.getTileSet(viewingPalette, MapIO.blockRenderer.currentTime).getHeight(), this);
	}
